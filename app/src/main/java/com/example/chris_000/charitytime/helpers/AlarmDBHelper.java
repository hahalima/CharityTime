...
public class AlarmDBHelper extends SQLiteOpenHelper {
    ...
    private AlarmModel populateModel(Cursor c) {
        ...
        model.alarmId = c.getLong(c.getColumnIndex(AlarmContract.Alarm._ID));
        model.alarmName = c.getString(c.getColumnIndex(AlarmContract.Alarm.COLUMN_NAME_ALARM_NAME));
    ...
    private ContentValues populateContent(AlarmModel model) {
        ...
        values.put(AlarmContract.Alarm.COLUMN_NAME_ALARM_NAME, model.alarmName);
    ...
    public long updateAlarm(AlarmModel model) {
        ContentValues values = populateContent(model);
        return getWritableDatabase().update(AlarmContract.Alarm.TABLE_NAME, values, AlarmContract.Alarm._ID + " = ?", new String[]{String.valueOf(model.alarmId)});
    }
